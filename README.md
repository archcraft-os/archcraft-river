...
>
> But, If you want to use **wofi** instead of **rofi**, Edit the config file `~/.config/river/init` and uncomment wofi keybindings (and, comment the rofi stuff as well).
